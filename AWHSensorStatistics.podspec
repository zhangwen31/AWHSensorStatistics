#
#  Be sure to run `pod spec lint AWHSensorStatistics.podspec' to ensure this is a
#  确保运行“pod spec lint AWHSensorStatistics.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHSensorStatistics"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHSensorStatistics.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHSensorStatistics/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHSensorStatistics/**/*.h"
  
  s.vendored_frameworks = ['AWHSensorStatistics.framework']
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHSensorStatisticsLocalizable.bundle']
